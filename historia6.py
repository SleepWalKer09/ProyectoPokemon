...
#Ventana del combate
hist6 = Tk()
hist6.geometry("900x560")
hist6.title("Pelea Entrenamiento")
hist6.resizable(False,False)
...
canvashist6 = Canvas(hist6, width=1000, height=500)
canvashist6.create_image( 0, 0, image = tk_gym, anchor = "nw")
canvashist6.pack(fill = "both", expand= True) 
...
Atq1= Button(hist6, command= PrimerAtaque)
Atq1.place(x=50, y= 100)
Atq2= Button(hist6, command= SegundoAtaque)
Atq2.place(x=50, y= 150)
Atq3= Button(hist6, command= TercerAtaque)
Atq3.place(x=50, y= 200)
Atq4= Button(hist6, command= CuartoAtaque)
