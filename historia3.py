...
#Ventana del combate
hist3 = Tk()
hist3.geometry("900x560")
hist3.title("Pelea Entrenamiento")
hist3.resizable(False,False)
...
canvashist3 = Canvas(hist3, width=1000, height=500)
canvashist3.create_image( 0, 0, image = tk_gym, anchor = "nw")
canvashist3.pack(fill = "both", expand= True) 
...
Atq1= Button(hist3, command= PrimerAtaque)
Atq1.place(x=50, y= 100)
Atq2= Button(hist3, command= SegundoAtaque)
Atq2.place(x=50, y= 150)
Atq3= Button(hist3, command= TercerAtaque)
Atq3.place(x=50, y= 200)
Atq4= Button(hist3, command= CuartoAtaque)
