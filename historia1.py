...
#Ventana del combate
hist1 = Tk()
hist1.geometry("900x560")
hist1.title("Pelea Entrenamiento")
hist1.resizable(False,False)
...
canvashist1 = Canvas(hist1, width=1000, height=500)
canvashist1.create_image( 0, 0, image = tk_gym, anchor = "nw")
canvashist1.pack(fill = "both", expand= True) 
...
#NIVEL 1: CPU PELEA CON AQUARDER
...
Atq1= Button(hist1, command= PrimerAtaque)
Atq1.place(x=50, y= 100)
Atq2= Button(hist1, command= SegundoAtaque)
Atq2.place(x=50, y= 150)
Atq3= Button(hist1, command= TercerAtaque)
Atq3.place(x=50, y= 200)
Atq4= Button(hist1, command= CuartoAtaque)
