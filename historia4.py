...
#Ventana del combate
hist4 = Tk()
hist4.geometry("900x560")
hist4.title("Pelea Entrenamiento")
hist4.resizable(False,False)
...
canvashist4 = Canvas(hist4, width=1000, height=500)
canvashist4.create_image( 0, 0, image = tk_gym, anchor = "nw")
canvashist4.pack(fill = "both", expand= True) 
...
#NIVEL 4: CPU PELEA CON MOUSEBUG
...
Atq1= Button(hist4, command= PrimerAtaque)
Atq1.place(x=50, y= 100)
Atq2= Button(hist4, command= SegundoAtaque)
Atq2.place(x=50, y= 150)
Atq3= Button(hist4, command= TercerAtaque)
Atq3.place(x=50, y= 200)
Atq4= Button(hist4, command= CuartoAtaque)
