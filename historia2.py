...
#Ventana del combate
hist2 = Tk()
hist2.geometry("900x560")
hist2.title("Pelea Entrenamiento")
hist2.resizable(False,False)
...
canvashist2 = Canvas(hist2, width=1000, height=500)
canvashist2.create_image( 0, 0, image = tk_gym, anchor = "nw")
canvashist2.pack(fill = "both", expand= True) 
...
CpuImagen= Label(image=tk_firesor)
CpuImagen.place(x=500,y=80)
nombrerival = Label(text="Firesor")
...
Atq1= Button(hist2, command= PrimerAtaque)
Atq1.place(x=50, y= 100)
Atq2= Button(hist2, command= SegundoAtaque)
Atq2.place(x=50, y= 150)
Atq3= Button(hist2, command= TercerAtaque)
Atq3.place(x=50, y= 200)
Atq4= Button(hist2, command= CuartoAtaque)
